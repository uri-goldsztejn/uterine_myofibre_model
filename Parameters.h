...
// This classs manages the cells parameters. These parameters are used to calculate the ionic currents at each iteration.
...
private:
	...
	double Fbca = 20; //buffer fractional stregnth factor
	...
	double Kd = 2.6e-4; //dissosiation constant
...
public:
	...
	// The initial values were determined such that the system is in equilibrium with those values.
	double la_ = 47.3542, ls_ = 41.365, lx_ = 31.28, lc_ = 120;

	//constants for mechanical model
	...
	double CaMLCK = 0.0004640758; //this is not const beacause I change it through the modulation
