...
// This abstract class is used to iterate over all currents. This object oriented design facilitates the implementation of our model with other ionic current models.
