...
//This object represents a single cell that will be part of the myofibre
class Cell
{
protected:
...
public:
	...
	// A copy constructor used to add the cells to the container. The container represents the myofibre
	...
	// These set-get methods are used to manage the phosphorylation states and cellular compartments' lengths
	double getAM();
	double getAMP();
	double getLa();
	double getLx();
