...
private:
	double Jnaca = 3.5e-6; // 1.75e-5;	/* maximal calium flux via Na-Ca exchanger  (mM/ms) */
...
public:
	...
	double getCurrent(CellParameters &parameters) {
		...
		// the 1/2 multiplier is added here instead of during the total calculation
	}
	...
	} // I need this to be public so I can calculate the Ca flux
